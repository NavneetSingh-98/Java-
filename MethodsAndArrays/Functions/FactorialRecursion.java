...
public class FactorialRecursion {
    ...
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        // Factorial Find with the help of Recursion 

        System.out.print("Enter Your Number : ");
        int num = input.nextInt();

        long fact = factorialCalculater(num);
        System.out.print("Your Factoril is "+fact);


    }
    public static long factorialCalculater(int num){
        if(num == 0 || num == 1)
            return 1;
            return num * factorialCalculater(num- 1);
