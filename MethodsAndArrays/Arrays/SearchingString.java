...
public class SearchingString {
    ...
    System.out.println("Welcome in the String Searching Program");
    Scanner input = new Scanner(System.in);

    String[] myArr  = {"Navneet", "Shivam","Aman","Sohan","Rohan"};

    System.out.println("Enter Your String You want to Search : ");

    String strArr = input.nextLine();

    boolean isFound = isFound(myArr, strArr);
    ...
    public static boolean isFound(String[] myArr, String strArr){
        int index = 0;
        while(index < strArr.length()){
            if(myArr[index] == strArr){
                return true;
            }
            index++;
        }
